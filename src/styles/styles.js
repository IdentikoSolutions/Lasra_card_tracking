...
export const button =`rounded-sm px-3 py-2 hover:bg-green-600 flex items-center text-white group disabled:bg-gray-500 bg-green-500 relative flex-1`
...
export const input ='border-2 shadow-md border-zinc-200 flex-1 h-[2rem] min-w-[200px] h-[1.5rem] rounded-md p-1 '
